...
// in simulator we redefine to format for simplegame Developer console
...
{\
	NSString * exceptionName = [@"org.simplegame." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simplegame";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsimplegameNativeItemNone = -1, 
	UIsimplegameNativeItemSpinner = -2,
	UIsimplegameNativeItemProgressBar = -3,
	
	UIsimplegameNativeItemSlider = -4,
	UIsimplegameNativeItemSwitch = -5,
	UIsimplegameNativeItemMultiButton = -6,
	UIsimplegameNativeItemSegmented = -7,
	
	UIsimplegameNativeItemTextView = -8,
	UIsimplegameNativeItemTextField = -9,
	UIsimplegameNativeItemSearchBar = -10,
	
	UIsimplegameNativeItemPicker = -11,
	UIsimplegameNativeItemDatePicker = -12,
	
	UIsimplegameNativeItemInfoLight = -13,
	UIsimplegameNativeItemInfoDark = -14,
	
	UIsimplegameNativeItemDisclosure = -15,
	
	UIsimplegameNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all simplegame instances of
