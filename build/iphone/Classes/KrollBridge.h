...
@interface simplegameObject : KrollCoverageObject {
#else
@interface simplegameObject : KrollObject {
#endif
@private
...
extern NSString * simplegame$ModuleRequireFormat;
