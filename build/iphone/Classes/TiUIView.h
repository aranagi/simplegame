...
/**
 Base class for all simplegame views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the simplegame view hierarchy (such as wrapped iOS UIViews) was touched.
